...
## How to Use It
Download the app EXE here: [https://github.com/MadSciSlack/Color-Swap-King/releases/download/V0.50-B0011/color_swap_king.exe](https://github.com/MadSciSlack/Color-Swap-King/releases/download/V0.60-B0013/color_swap_king.exe). That file is located here in this repository through Github's Large File Storage (LFS).
